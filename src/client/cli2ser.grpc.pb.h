 ...
 public:
  ...
  class WithAsyncMethod_SayHello : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status SayHello(::grpc::ServerContext* context, const ::Rpc::HelloRequest* request, ::Rpc::HelloReply* response) final override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithStreamedUnaryMethod_SayHello : public BaseClass {
   ...
   public:
    WithStreamedUnaryMethod_SayHello() {
      ::grpc::Service::MarkMethodStreamed(2,
        new ::grpc::internal::StreamedUnaryHandler< ::Rpc::HelloRequest, ::Rpc::HelloReply>(std::bind(&WithStreamedUnaryMethod_SayHello<BaseClass>::StreamedSayHello, this, std::placeholders::_1, std::placeholders::_2)));
    }
 ...
 public:
  ...
  class WithAsyncMethod_MultiWrite : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status MultiWrite(::grpc::ServerContext* context, const ::Rpc::MultiWriteRequest* request, ::Rpc::MultiWriteReply* response) final override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_CopyChunkWrite : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status CopyChunkWrite(::grpc::ServerContext* context, const ::Rpc::CopyChunkWriteRequest* request, ::Rpc::CopyChunkWriteReply* response) final override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithStreamedUnaryMethod_MultiWrite : public BaseClass {
   ...
   public:
    WithStreamedUnaryMethod_MultiWrite() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler< ::Rpc::MultiWriteRequest, ::Rpc::MultiWriteReply>(std::bind(&WithStreamedUnaryMethod_MultiWrite<BaseClass>::StreamedMultiWrite, this, std::placeholders::_1, std::placeholders::_2)));
    }
  ...
  class WithStreamedUnaryMethod_CopyChunkWrite : public BaseClass {
   ...
   public:
    WithStreamedUnaryMethod_CopyChunkWrite() {
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::internal::StreamedUnaryHandler< ::Rpc::CopyChunkWriteRequest, ::Rpc::CopyChunkWriteReply>(std::bind(&WithStreamedUnaryMethod_CopyChunkWrite<BaseClass>::StreamedCopyChunkWrite, this, std::placeholders::_1, std::placeholders::_2)));
    }
